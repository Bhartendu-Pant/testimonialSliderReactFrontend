...
export const Testimonials = (props) => {
  ...
  return (
    <div className="rounded-md relative w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-20 p-10 transition-all duration-700 hover:shadow-lg">
